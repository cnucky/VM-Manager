  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.powerControlType" placeholder="电源控制类型" class="filter-item" clearable style="width: 150px">
        <el-option label="定时启动" value="start"></el-option>
        <el-option label="定时关闭" value="stop"></el-option>
        <el-option label="定时重启" value="restart"></el-option>
        <el-option label="智能启动" value="AIstart"></el-option>
      </el-select>
      ...
      <el-select v-model="listQuery.appObjectType" placeholder="应用对象类型" class="filter-item" clearable style="width: 150px">
        ...
        <el-option label="桌面组" value="desktopGroup"></el-option>
      </el-select>
