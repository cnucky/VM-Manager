<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.type" placeholder="筛选类型" class="filter-item" clearable style="width: 140px">
        <el-option label="随机池" value="suiji" />
        <el-option label="静态池" value="jingtai" />
        <el-option label="标准桌面" value="biaozhun" />
        <el-option label="3D桌面" value="3d" />
      </el-select>
      ...
      <el-select v-model="listQuery.maintain" placeholder="维护模式" class="filter-item" clearable style="width: 140px">
      ...
      <el-button v-waves class="filter-item" style="margin-left: 10px;" type="danger" icon="el-icon-refresh" @click="handleReset">重置</el-button>
...
<script>
import waves from '@/directive/waves/index.js' // waves directive
